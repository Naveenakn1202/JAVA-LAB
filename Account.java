...
public class Bank {
 ...
 int i=0;
 while(i<2) {
 System.out.println("Enter the account type\nEnter 'curr' for current account \n Enter 'sav' for savings
account");
 String type = in.next();
 if(type.equals("curr")) {
 System.out.println("Enter the balance of Current account");
...
System.out.println("Enter the balance of Savings account");
 double bal = in.nextInt();
